...
export class DeskResolver {
  ...
  createDesk(@Args('desk_name') desk_name: string) {
    return this.deskService.createDesk(desk_name);
  }
  @Mutation(returns => DeskError, { nullable: true })
  removeDesk(@Args('desk_name') desk_name: string) {
    return this.deskService.removeDesk(desk_name);
  }
  @Mutation(returns => DeskError, { nullable: true })
  editDesk(
    ...
    return this.deskService.editDesk(new_desk_name, old_desk_name);
  }
}
